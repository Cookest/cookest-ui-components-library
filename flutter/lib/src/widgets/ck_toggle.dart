...
/// Toggle size matching the React Toggle component.
enum CkToggleSize { sm, md, lg }

/// A toggle switch matching the web @cookest/ui Toggle.
class CkToggle extends StatelessWidget {
  const CkToggle({
    super.key,
    required this.value,
    ...
    this.label,
    this.description,
    this.toggleSize = CkToggleSize.md,
    this.enabled = true,
  });
  ...
  final CkToggleSize toggleSize;
  final bool enabled;

  Size get _trackSize {
    switch (toggleSize) {
      case CkToggleSize.sm:
        return const Size(36, 20);
      case CkToggleSize.md:
        return const Size(44, 24);
      case CkToggleSize.lg:
